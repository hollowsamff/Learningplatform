	...
	if (!empty($user_image_temp)) {
	    ...
	    if(empty($error)){ //When no errors are found edit page
			  ...
			  if(empty($user_image)){//If user does not change image one keep current image
					...
					$stmt2 = mysqli_prepare($connection,"SELECT indivigual_page_content_image_one FROM indivigual_page_content WHERE indivigual_page_content_id = 22");
			     ...
			     mysqli_stmt_close($stmt2);//Close statment connection 
				  ...
				  if(empty($user_image2)){//If user does not change image one keep current image
					...
					$stmt2 = mysqli_prepare($connection,"SELECT indivigual_page_content_image_two FROM indivigual_page_content WHERE indivigual_page_content_id = 22");
					mysqli_stmt_execute($stmt2);
			...
			WHERE indivigual_page_content_id = 22");
        ...
        <div id="page-wrapper">
			 ...
			 <div class="container-fluid">
				...
				<div class = "form-group">
					<img width='100' src ='../images/<?php echo $user_image ?>' alt='Image one of Sam Francis Bath College profile site aboutus page'>
					</div>
					<div class = "form-group">
					...
					<div class = "form-group">
					<img width='100' src ='../images/<?php echo $user_image2 ?>' alt='Image two of Sam Francis Bath College profile site aboutus pagee'>
					</div>
					<div class = "form-group">
