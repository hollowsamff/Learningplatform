...
<div id="wrapper">
  ...
  <div id="page-wrapper">
		  ...
		  <section class="col-lg-12">
			...
			<button name="showQuestionnaireResults" id="showStackedChartQuestionnaireChart" class="btn btn-primary">Website questionnaire results</button><br><br>
		  </section>
		  ...
		  <div id="visualization_wrap" class="hide"> 
			   ...
			   <strong>
			      Users responce to website questionnaire
			   </strong>
			
			 <figure id="stackedChartHolder" class="hide"></figure>
		  </div>
		  
		  <p><strong>Students rating of current online learning resources summary table</strong></p>
		  <table id="stackedChartTable" class="hide">

			<thead>			
			  <tr>
				<td>Responce question</td>
		  ...
		  <!--All user scores averages bar chart  -->
		  ...
		  <table id="allUserScoresCollumTable" class="hide">
			...
			<thead>
			  <tr>
				<td>Admin user mean grade</td>
				<td>Non-admin user mean grade</td>
			  </tr>
			</thead>
			<tbody>
			  <tr>
				<td id="onlineStudentMeanGrade"></td>
				<td id="classroomStudentMeanGrade"></td>
			  </tr>
			</tbody>
		  </table>
		  ...
		  <section class="table-responsive">
			...
			<p><strong>User online time</strong></p>
		  ...
		  <section class="table-responsive">
			...
			<p><strong>Average grades for the website quizzes and tests</strong></p>
		  ...
		  <section class="table-responsive">
			...
			<p><strong>All the users resuts for the website quizzes and tests</strong></p>
		  ...
		  <article class="table-responsive">
			...
			<p><strong>Weekly average scores for the website quizzes and tests</strong></p>
      ...
      function drawStudentsQuizScoresChart(userScoresArray) { //Draw the collum chart that shows all the users average scores - gets data from the getAllUserScores function
        ...
        if (typeof userScoresArray !== 'undefined') {
          ...
          for (var i = 0; i < userScoresArray.length; i++) { //Add the collums to the  line chart		
            ...
            if (userScoresArray[i]["userRole"] == "admin") {
